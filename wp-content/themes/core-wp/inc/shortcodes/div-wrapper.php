...
if ( ! function_exists( 'core_wp_div_wrapper' ) ) {
	/**
	 ...
	 */
	function core_wp_div_wrapper( $atts, $content, $tag ) {
		$default_class = '';
...
add_shortcode( 'row', 'core_wp_div_wrapper' );
add_shortcode( 'column', 'core_wp_div_wrapper' );
add_shortcode( 'columns', 'core_wp_div_wrapper' );
