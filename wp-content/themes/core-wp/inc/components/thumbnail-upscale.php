...
if ( ! function_exists( 'core_wp_thumbnail_upscale' ) ) {
	/**
	 * Upscale thumbnails
	 *
	 * @link https://developer.wordpress.org/reference/hooks/image_resize_dimensions/
	 *
	 * @method core_wp_thumbnail_upscale
	 ...
	 */
	function core_wp_thumbnail_upscale( $preempt, $orig_w, $orig_h, $new_w, $new_h, $crop ) {
		if ( ! $crop ) {
...
add_filter( 'image_resize_dimensions', 'core_wp_thumbnail_upscale', 10, 6 );
