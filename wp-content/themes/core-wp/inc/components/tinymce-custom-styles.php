...
if ( ! function_exists( 'core_wp_button_format' ) ) {
	/**
	 ...
	 */
	function core_wp_button_format( $buttons ) {
		array_unshift( $buttons, 'styleselect' );

		return $buttons;
	}
}
add_filter( 'mce_buttons_2', 'core_wp_button_format' );


if ( ! function_exists( 'core_wp_insert_formats' ) ) {
	/**
	 ...
	 */
	function core_wp_insert_formats( $init_array ) {
...
add_filter( 'tiny_mce_before_init', 'core_wp_insert_formats' );
