...
<div class="wp-block-group midline-cta midline-cta-light has-light-gray-background-color has-background">
	...
	<div class="wp-block-columns is-layout-flex midline-cta-cols midline-cta-cols-stack-tablet">
		...
		<div class="wp-block-column" style="flex-basis:66.66%">
			...
			<h2 class="wp-block-heading has-black-color has-text-color">A Large Headline That Anchors the Right Side</h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"className":"midline-cta-stat-number","textColor":"dark-navy","style":{"spacing":{"margin":{"top":"1.5rem"}}}} -->
			<p class="midline-cta-stat-number has-dark-navy-color has-text-color" style="margin-top:1.5rem">30%</p>
			<!-- /wp:paragraph -->
