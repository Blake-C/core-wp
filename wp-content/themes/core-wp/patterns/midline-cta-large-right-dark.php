...
<div class="wp-block-group midline-cta midline-cta--dark has-dark-navy-background-color has-background">
	...
	<div class="wp-block-columns is-layout-flex midline-cta__cols midline-cta__cols--stack-tablet">
		...
		<div class="wp-block-column" style="flex-basis:66.66%">
			...
			<h2 class="wp-block-heading has-white-color has-text-color has-medium-font-size">A Large Headline That Anchors the Right Side</h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"className":"midline-cta__stat-number","textColor":"white","style":{"spacing":{"margin":{"top":"1.5rem"}}}} -->
			<p class="midline-cta__stat-number has-white-color has-text-color" style="margin-top:1.5rem">30%</p>
			<!-- /wp:paragraph -->
